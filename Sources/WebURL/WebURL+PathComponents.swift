...
extension WebURL.PathComponents {
  ...
  /// - returns: A range of indexes which include the appended component.
  ///            The range's `lowerBound` is the index of the appended component,
  ///            and its `upperBound` is equal to `endIndex`.
  ///
  @inlinable
  @discardableResult
  public mutating func append<Component>(
    ...
    // TODO: This should just return 'lowerBound', 'upperBound' is always endIndex... isn't it?
...
extension WebURL.PathComponents {
  ...
  /// > This function invalidates any existing indexes for this URL.
  ///
  /// - returns: The index of the last component in the path.
  ///            The component at this index will be an empty string.
  ///
  @discardableResult
